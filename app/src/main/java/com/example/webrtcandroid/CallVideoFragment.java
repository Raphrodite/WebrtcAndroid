...
public class CallVideoFragment extends Fragment {
    ...
    private CallVideoActivity activity;

    @Override
    public void onAttach(Context context) {
        super.onAttach(context);
        activity = (CallVideoActivity) getActivity();
    ...
    private View onInitloadView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_call_video, container, false);
    }
